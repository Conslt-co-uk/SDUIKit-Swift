...
@MainActor @Observable public class InputComponent: Component {
    ...
    required init(object: JSONObject, screen: Screen, registrar: Registrar) {
        ...
        titleStyleExpression = StyleExpression(object: object, registrar: registrar, stylesheet: screen.stack!.app!.stylesheet, styleName: "input", prefix: "title")
        errorStyleExpression = StyleExpression(object: object, registrar: registrar, stylesheet: screen.stack!.app!.stylesheet, styleName: "input", prefix: "error")
